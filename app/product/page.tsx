      ...
      <section className="container mx-auto px-4 py-8 md:py-12">
        <div className="text-center max-w-3xl mx-auto mb-10">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-secondary-charcoal">
            LuxGlow <span className="text-primary-red">Brightening Cream</span>
          </h1>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <ol className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium">Apply Cream</h3>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Always use SPF during daytime to protect your skin and enhance the cream's effects.</p>
                  </div>
                </li>
              </ol>
